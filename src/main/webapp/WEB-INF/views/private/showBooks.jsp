...
<body>
	...
	<nav>
		<ul>
			<li><a href="newBook"><spring:message code="shoppingCart.addNew"/></a></li>
	...
	<section>
		...
		<article>
			<a href="shoppingCart/showForm"><spring:message code="shoppingCart.title"/></a><br /> 
			<a href="shoppingCart/show"><spring:message code="shoppingCart.show"/></a><br /> 
			
			<table>
				<caption><spring:message code="showBooks.catalog"/>:</caption>
				<thead>
					<tr>
